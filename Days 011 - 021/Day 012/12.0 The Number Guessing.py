...
# Check user's guess against actual answer - NOT MINE. Print "Too high." or "Too low." depending on the user's answer - NOT MINE.
# If they got the answer - NOT MINE correct, show the actual answer - NOT MINE to the player.
